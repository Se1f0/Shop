                                        ...
                                        <div class="myaccount-content">
                                            ...
                                            <div class="myaccount-table table-responsive text-center">
                                                ...
                                                @if ($order->status == 'ordered')
                                                    <a href="#" class="btn btn-danger mb-10" role="button" wire:click.prevent="cancelOrder" onclick="confirm('Are you sure,You want to cancel this order?') || event.stopImmediatePropagation()">Cancel Order</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
